...
\begin{longtable}{|M{0.5cm}|M{2cm}|M{3cm}|M{3.5cm}|M{4.5cm}|M{1cm}|M{1.5cm}|
    ...
    \hline
        ...
        \hline %48
        \showmycounter  & Administrador
        & Recibir notificaciones de denuncias.
        & Ver las denuncias que realizan los usuarios de la plataforma.
        & El administrador podrá vera una pestaña en la que tendrá acceso a una
        lista de todas las notificaciones de denuncias recibidas
        &   &      &   &  
        & No asignado. \\
        \hline %49
        \showmycounter  & Administrador
...
\begin{longtable}{|M{4cm}|M{1cm}|M{1.5cm}|M{2.5cm}|M{6cm}|}
    ...
    \hline
    El software presenta errores inesperados tiempo después de haber sido completado en iteraciones anteriores.
    & 1 & 3  & 30\%  
