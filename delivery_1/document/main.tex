...
del 2020 (3 meses). Por lo tanto todos los gastos se contemplan para este tiempo
estimado.\\
...
serán por prestación de servicios. 
...
\begin{table}[H]
    ...
    \begin{tabular}{R{6cm}L{6cm}}
        ...
        \multicolumn{2}{c}{Desarrolladores \dotfill \$7'149.117} \\
        \hline
        \multicolumn{2}{c}{\textbf{Total} \dotfill \$18'976.056} \\
    \end{tabular}
    \label{T04}}
\end{table}{}
...
\begin{table}[H]
    ...
    \begin{tabular}{R{6cm}L{6cm}}
        ...
        \\
        \multicolumn{2}{c}{Costos directos personal  \dotfill  \$18'976.056} \\
        \multicolumn{2}{c}{Costos directos e indirectos 
        de recursos fisicos \dotfill \$3'279.000} \\
        \hline
        \multicolumn{2}{c}{\textbf{Total} \dotfill \$22'255.056} \\
    \end{tabular}
    \label{T05}}
\end{table}{}
